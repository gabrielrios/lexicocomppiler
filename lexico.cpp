...
bool Lexico::print_file_symbol(){
    ...
    file_symbols << "Tabela de sÌmbolos" << endl << endl;
...
bool Lexico::print_file_errors(){
	...
	file_errors << "CÛdigo com erros encontrados" << endl << endl;
	file_errors << "Arquivo de entrada (versão " << versao << "): " << file_name.str() << endl << endl << endl;
	file_errors << "Linha CÛdigo" << endl;
	file_errors << "----- -----------------------------------------------------" << endl;
    ...
    for(int i = 0; i < source.size(); i++){
        ...
        if (errors.empty()) {
            ...
            for(int j = 0; j < errors.size(); j++){
				...
				file_errors << "^ " << endl;
				file_errors << format;
				file_errors << "Erro lÈxico na linha " << errors[j].linha+1 << " coluna " << errors[j].coluna+1 << ": ";
